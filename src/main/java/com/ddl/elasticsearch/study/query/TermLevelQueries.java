...
public class TermLevelQueries extends ElasticsearchClientBase {
    ...
    public void testTermsQuery() throws Exception {
        QueryBuilder qb = termsQuery(
                "user",    //field
                "kimchy", "quanke.name");                    //values

        twitterPrepareSearch(qb);///一个属性的多个具体值查找
    }
...
//        rangeQueryBuilder.includeUpper(true);
        ...
        QueryBuilder qb = QueryBuilders.rangeQuery("age").gte(1).lte(2);
    ...
    public void testExistsQuery() throws Exception {
        ...
        twitterPrepareSearch(qb);///查询有某个属性的
    }
